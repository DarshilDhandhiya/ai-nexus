...
import { LayoutDashboard, MessageSquare, ImageIcon, ImagePlus, VideoIcon, Music, Code, Settings } from "lucide-react";
        ...
        <div className="space-y-4 py-4 flex-col h-full bg-[#111827] text-white">
            <div className="px-3 py-2 flex-1">
                <Link href="/dashboard" className="flex items-center pl-3 mb-14">
                    ...
                    <h1 className={cn ("text-2xl font-bold", montserrat.className)}>Nexus</h1>
                </Link>
